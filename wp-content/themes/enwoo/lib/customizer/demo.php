...
function enwoo_customizer_demo_content($wp_customize) {
    ...
    if (is_plugin_active('envo-extra/envo-extra.php')) {
        ...
        $theme_demo_content_desc .= '<p><a class="button button-primary" href="' . esc_url(admin_url('themes.php?page=et_enwoo&tab=import_data')) . '" title="">' . esc_html__('Import demo data', 'enwoo') . '</a></p>';
    }
    $wp_customize->add_setting(
