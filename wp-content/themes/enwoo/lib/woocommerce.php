...
if (!function_exists('enwoo_header_cart')) {
    ...
    add_action('enwoo_header', 'enwoo_header_cart', 30);
...
if (!function_exists('enwoo_my_account')) {
    ...
    add_action('enwoo_header', 'enwoo_my_account', 40);
...
if (!function_exists('enwoo_head_wishlist')) {
    ...
    add_action('enwoo_header', 'enwoo_head_wishlist', 50);
...
if (!function_exists('enwoo_head_compare')) {
    ...
    add_action('enwoo_header', 'enwoo_head_compare', 60);
...
if (!function_exists('enwoo_head_search_bar')) {
    ...
    add_action('enwoo_header', 'enwoo_head_search_bar', 20);
...
if (!function_exists('enwoo_search_button')) {
    ...
    add_action('enwoo_header', 'enwoo_search_button', 70);
