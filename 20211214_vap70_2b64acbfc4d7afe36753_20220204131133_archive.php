...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211214_vap70_2b64acbfc4d7afe36753_20220204131133_archive.zip';
	const ARCHIVE_SIZE		 = '110881446';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '2b64acb-04131133';
    const SECONDARY_PACKAGE_HASH = '5fe38cd-04131133';
	const VERSION			 = '1.4.4';
